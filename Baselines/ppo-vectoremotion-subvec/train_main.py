...
def get_config():
    ...
    parser.add_argument("--run_name", type=str, default="ppo-vectoremotion", help="Run name, default: ppo-vectoremotion")
        ...
        for i in range(0, config.episodes):
            ...
            for t in range(500):
                ...
                for m in range(len(state)):
                    ...
                    indices_to_extract = list(range(0, 15)) +  [15, 17, 19, 21, 23, 25]
