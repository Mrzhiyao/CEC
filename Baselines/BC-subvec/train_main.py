...
def get_config():
    ...
    parser.add_argument("--run_name", type=str, default="BC", help="Run name, default: BC")
...
def train(config):
    ...
    agent = BC(state_dim_actor, action_dim, actor_node, lr_actor, device)
        ...
        for i in range(0, config.episodes):
            ...
            for t in range(500):
                ...
                for m in range(len(state)):
                    ...
                    action1, action2 = agent.get_actions(result_state_add)
                ...
                if (t+1) % 10 == 0 and t != 0:
                    ...
                    for task_file in tasks_list:
                        ...
                        try:
                            ...
                            print('rewards', rewards_mem, spend_time, completion)
