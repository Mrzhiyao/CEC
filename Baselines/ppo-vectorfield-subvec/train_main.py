...
def get_config():
    ...
    parser.add_argument("--run_name", type=str, default="ppo-vectorfield", help="Run name, default: ppo-vectorfield")
        ...
        for i in range(0, config.episodes):
            ...
            for t in range(500):
                ...
                for m in range(len(state)):
                    ...
                    indices_to_extract = list(range(0, 15)) +  [15, 16, 19, 20, 23, 24]  # 0-14, 15, 19, 23 (共18个)
