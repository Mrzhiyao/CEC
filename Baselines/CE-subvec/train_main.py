...
def get_config():
    ...
    parser.add_argument("--run_name", type=str, default="greedy_resource", help="Run name, default: greedy_resource")
        ...
        for i in range(0, config.episodes):
            ...
            for t in range(0, 500):
                ...
                for m in range(len(state)):
                    action1, action2, lunxun_new = agent.get_action_algorithm1(state[m], lunxun_st)
                    lunxun_st = lunxun_new
