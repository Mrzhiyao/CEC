...
def collect_random_main_train_test(dataset):
    ...
    print(len(loaded_lists_sim_subvec), len(loaded_lists_relu_subvec))
    experience = []
    for _ in range(1000):
        ...
        # if _ < 100:
        #     print('loaded_lists_sim', result_state[0],result_state[2],result_state[4], result_state[15:19],result_state[35:39],result_state[55:59], action, reward)
        #     print('\n')
        ...
        # print(len(result_state_add), len(result_next_add))
        experience.append([result_state_add, action, reward, result_next_add, done])

    # for _ in range(len(loaded_lists_relu)):
    ...
    # for _ in range(len(loaded_lists_relu_subvec)):
    #     state = loaded_lists_relu[_][0]
    #     action = loaded_lists_relu[_][1]
    #     reward = loaded_lists_relu[_][2]
    #     next_state = loaded_lists_relu[_][3]
    ...
    # for _ in range(len(loaded_lists_rl_subvec)):
    #     state = loaded_lists_relu[_][0]
    #     action = loaded_lists_relu[_][1]
    #     reward = loaded_lists_relu[_][2]
    #     next_state = loaded_lists_relu[_][3]
...
# collect_random_main_train_test([])