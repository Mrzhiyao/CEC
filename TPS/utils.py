...
_EXPERT_DEMO = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'expert_demonstrations')
...
def collect_random_main_train_test(dataset):
    ...
    with open(os.path.join(_EXPERT_DEMO, 'memory_sim_new_reward_high_cost.pkl'), 'rb') as file:
        loaded_lists_sim = pickle.load(file)

    with open(os.path.join(_EXPERT_DEMO, 'memory_relu_new_reward.pkl'), 'rb') as file:
        loaded_lists_relu = pickle.load(file)

    with open(os.path.join(_EXPERT_DEMO, 'memory_sim_subvec_reward_high_cost.pkl'), 'rb') as file:
        loaded_lists_sim_subvec = pickle.load(file)

    with open(os.path.join(_EXPERT_DEMO, 'memory_relu_subvec_reward.pkl'), 'rb') as file:
        loaded_lists_relu_subvec = pickle.load(file)

    with open(os.path.join(_EXPERT_DEMO, 'memory_rl_subvec_reward.pkl'), 'rb') as file:
