...
# oasst1_val = Collection("crewai_agents1_keywords")
# oasst1_val = Collection("crewai_agents1_keywords_qw14b")
oasst1_val = Collection("crewai_agents1_keywords_algorithm1_insert")
def insert_keywords_data(words, words_rank, source, source_id, type_id):
    words = words.replace("(","")
    words = words.replace(")","")
    words = words.replace("（","")
    words = words.replace("）","")
