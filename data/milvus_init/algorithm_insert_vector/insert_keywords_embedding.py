...
from insert_milvus import insert_data
from utils import get_type_id

from insert_keywords_milvus import insert_keywords_data
from get_keywords import get_keywords

def insert_keywords_result(oasst1_val, q, content, type_id, q_id, a_id):
    ...
    for words_rank, words in q_words:
        ...
        if words_rank >1.0:
            ...
            insert_keywords_data(oasst1_val, words, words_rank, q, q_id, type_id)
            number_q = number_q + 1
    for words_rank, words in a_words:
        ...
        if words_rank >1.0:
            # print('start')
            # print(words_rank, words)
            insert_keywords_data(oasst1_val, words, words_rank, content, a_id, type_id)
            number_a = number_a + 1
