...
connections.connect("default", host="YOUR_EDGE_NODE1_IP", port="19530")
fields = [
    ...
    FieldSchema(name="role", dtype=DataType.VARCHAR, max_length=65000),
    FieldSchema(name="filed", dtype=DataType.VARCHAR, max_length=65000),
    FieldSchema(name="emotion", dtype=DataType.VARCHAR, max_length=65000),
    FieldSchema(name="text_answer", dtype=DataType.VARCHAR, max_length=65000),
    FieldSchema(name="text_answerid", dtype=DataType.VARCHAR, max_length=65000),
    FieldSchema(name="class_id", dtype=DataType.VARCHAR, max_length=65000),
]
schema = CollectionSchema(fields, "crewai_agents1_algorithm1_subvec")
oasst1_val = Collection("crewai_agents1_algorithm1_subvec", schema)
# [[1,2,3,4]]
